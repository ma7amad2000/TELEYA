...
PP_TOO_SMOL = "**𖢿╎الصورة صغيرة جدًا  📸** ."
PP_ERROR = "**𖢿╎فشل أثناء معالجة الصورة  📵** ."
NO_ADMIN = "**𖢿╎أنا لست مشرف هنا ** ."
NO_PERM = "**𖢿╎ليس لدي أذونات كافية  🚮** ."
CHAT_PP_CHANGED = "**𖢿╎تغيّرت صورة الدردشة  🌅** ."
...
#                                                           ZThon                                                                #
# =========================================================== #
STAT_INDICATION = "**𖢿╎جـارِ جـلب الاحصـائيـات إنتظـر ⅏ . . .**"
CHANNELS_STR = "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"
# =========================================================== #
#                                                           ZThon                                                                #
# =========================================================== #
...
async def stats(event):  # sourcery no-metrics
    ...
    response = f"𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات {full_name}** 𓆪\n"
...
async def scrapmem(event):
    chat = event.chat_id
    xx = await edit_or_reply(event, "**𖢿╎جـارِ إتمـام العمليـة إنتظـر ⅏ . . .**")
...
async def admem(event):
    ...
    for user in users:
        ...
        try:
            ...
            await xx.edit(f"**𖢿╎تم إكمـال العمليـه جـارِ اضافـة** `{n}` **مـن الاعضـاء . .**")
        except TypeError:
            n -= 1
            continue
...
async def info(event):
    ...
    zedevent = await edit_or_reply(event, "**𖢿╎جـارِ جلـب معلومـات الدردشـة، إنتظـر ⅏**")
    ...
    try:
        ...
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID, f"**𖢿╎هنـاك خطـأ في معلومـات الدردشـة ✕ : **\n`{str(e)}`"
            )

        await zedevent.edit("**𖢿╎حـدث خـطأ مـا، يرجـى التحقق من الأمـر ⎌**")
...
async def get_chatinfo(event, zedevent):
    ...
    try:
        ...
        try:
            ...
            await zedevent.edit("**𖢿╎لـم يتـمّ العثـور على القنـاة/المجموعـة ✕**")
            return None
        except ChannelPrivateError:
            await zedevent.edit(
                "**𖢿╎هـذه مجموعـة أو قنـاة خاصـة أو لقد تمّ حظـري منه ⛞**"
            )
            return None
        except ChannelPublicGroupNaError:
            await zedevent.edit("**𖢿╎القنـاة أو المجموعـة الخارقـة غيـر موجـودة ✕**")
            return None
        except (TypeError, ValueError) as err:
            LOGS.info(err)
            await edit_delete(zedevent, "**𖢿╎لم يتم العثور على المجموعة او القناة**")
            return None
    return chat_info
...
async def fetch_info(chat, event):  # sourcery no-metrics
    ...
    caption = "<b>𖢿╎معلومـات الدردشـة  🝢 :</b>\n\n"
    caption += f"<b>𖢿╎الآيـدي  :</b> <code>{chat_obj_info.id}</code>\n"
    if chat_title is not None:
        caption += f"<b>𖢿╎إسـم المجموعـة :</b> {chat_title}\n"
    if former_title is not None:  # Meant is the very first title
        caption += f"<b>𖢿╎الإسم السابـق :</b>  {former_title}\n"
    if username is not None:
        caption += f"<b>𖢿╎نـوع المجموعـة ⌂:</b>  مجموعـة عامّـة  \n"
        caption += f"<b>𖢿╎الرابـط :</b>  \n {username}\n"
    else:
        caption += f"<b>𖢿╎نـوع المجموعـة ⌂:</b>  مجموعـة عامّـة  \n"
    if creator_username is not None:
        caption += f"<b>𖢿╎المالـك :</b>   {creator_username}\n"
    elif creator_valid:
        caption += ('<b>𖢿╎المالـك :</b>  <a href="tg://user?id={creator_id}">{creator_firstname}</a>\n')
    if created is not None:
        caption += f"<b>𖢿╎تاريـخ الإنشـاء :</b>  \n <code>{created.date().strftime('%b %d, %Y')} - {created.time()}</code>\n"
    else:
        caption += f"<b>𖢿╎الإنتـاج :</b>    <code>{chat_obj_info.date.date().strftime('%b %d, %Y')} - {chat_obj_info.date.time()}</code> {warn_emoji}\n"
    caption += f"<b>𖢿╎آيـدي قاعـدة البيانـات:</b>  {dc_id}\n"
    if exp_count is not None:
        chat_level = int((1 + sqrt(1 + 7 * exp_count / 14)) / 2)
        caption += f"<b>𖢿╎الأعضـاء:</b>  <code>{chat_level}</code>\n"
    if messages_viewable is not None:
        caption += f"<b>𖢿╎الرسائـل التي يمڪن مشاهدتها:</b>  <code>{messages_viewable}</code>\n"
    if messages_sent:
        caption += f"<b>𖢿╎الرسائـل المرسلـة :</b> <code>{messages_sent}</code>\n"
    elif messages_sent_alt:
        caption += f"<b>𖢿╎الرسـائل المرسلة: <code>{messages_sent_alt}</code> {warn_emoji}\n"
    if members is not None:
        caption += f"<b>𖢿╎الأعضـاء:</b>  <code>{members}</code>\n"
    if admins is not None:
        caption += f"<b>𖢿╎المشرفيـن:</b>  <code>{admins}</code>\n"
    if bots_list:
        caption += f"<b>𖢿╎البـوتات:</b>  <code>{bots}</code>\n"
    if members_online:
        caption += f"<b>𖢿╎المتصليـن حـالياً:</b>  <code>{members_online}</code>\n"
    if restrcited_users is not None:
        caption += f"<b>𖢿╎الأعضـاء المقيّديـن:</b>  <code>{restrcited_users}</code>\n"
    if banned_users is not None:
        caption += f"<b>𖢿╎الأعضـاء المحظوريـن:</b>  <code>{banned_users}</code>"
    if group_stickers is not None:
        caption += f'{chat_type} <b>𖢿╎الملصقـات:</b>  <a href="t.me/addstickers/{chat.full_chat.stickerset.short_name}">{group_stickers}</a>'
    caption += "\n"
    if not broadcast:
        caption += f"<b>𖢿╎الوضـع البطيئ:</b>  {slowmode}"
        if (
            ...
            caption += "\n"
        caption += f"<b>𖢿╎الـمجموعـة الخارقـة :</b>  {supergroup}\n"
    if hasattr(chat_obj_info, "restricted"):
        caption += f"<b>𖢿╎المقيّـد:</b>  {restricted}"
        if chat_obj_info.restricted:
            caption += f">:</b>  {chat_obj_info.restriction_reason[0].platform}\n"
            caption += f"> <b>𖢿╎السـبب :</b>  {chat_obj_info.restriction_reason[0].reason}\n"
            caption += f"> <b>𖢿╎النّـص :</b>  {chat_obj_info.restriction_reason[0].text}\n\n"
        else:
            caption += "\n"
    if hasattr(chat_obj_info, "scam") and chat_obj_info.scam:
        caption += "<b>𖢿╎السارقيـن:</b>  <b>Yes</b>\n"
    if hasattr(chat_obj_info, "verified"):
        caption += f"<b>𖢿╎الحسابـات الموثقـة  :</b>  {verified}\n"
    if description:
        caption += f"<b>𖢿╎الوصـف :</b>  \n<code>{description}</code>\n"
    return caption
...
async def _(event):  # sourcery no-metrics
    ...
    if input_str:
        ...
        if not chat.admin_rights and not chat.creator:
            await edit_or_reply(event, "**𖢿╎عـذراً عـزيـزي .. انت لسـت مشرفـاً هنـا 🙇🏻**")
            return False
    p = 0
    b = 0
    c = 0
    ...
    async for i in event.client.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
        ...
        await sleep(5)
    await et.edit(
        """𓆰 𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻
⪼ **العدد ↫ {} **مستخدماً
⪼ **الحسابات المحذوفه ↫** {}
⪼ **اخر ظهور منذ زمن طويل ↫** {}
⪼ **اخر ظهور منذ شهر ↫** {}
...
async def _(event):
    zedevent = await edit_or_reply(event, "**𖢿╎ إلغاء حظر جميع الحسابات المحظورة في هذه المجموعة 🆘**")
    succ = 0
    total = 0
    flag = False
    chat = await event.get_chat()
    async for i in event.client.iter_participants(event.chat_id, filter=ChannelParticipantsKicked, aggressive=True):
        ...
        try:
            ...
            LOGS.warn(f"**𖢿╎هناك ضغط كبير بالاستخدام يرجى الانتضار .. ‼️ بسبب  : {e.seconds} **")
            await zedevent.edit(f"**𖢿╎{readable_time(e.seconds)} مطلـوب المـعاودة مـرة اخـرى للـمسح 🔁 **")
            ...
            try:
                if succ % 10 == 0:
                    await zedevent.edit(f"**𖢿╎جـارِ مسـح المحـظورين ⭕️  : \n {succ} الحسـابات الـتي غيـر محظـورة لحـد الان.**")
            except MessageNotModifiedError:
                pass
    await zedevent.edit(f"**𖢿╎تـم مسـح المحـظورين مـن أصـل 🆘 :**{succ}/{total} \n اسـم المجـموعـة 📄 : {chat.title}")

@zedub.zed_cmd(pattern=r"المحذوفين ?([\s\S]*)")
async def rm_deletedacc(show):
    con = show.pattern_match.group(1).lower()
    del_u = 0
    del_status = "**𖢿╎لا توجـد حـسابات محذوفـة في هـذه المجموعـة !**"
    if con != "تنظيف":
        event = await edit_or_reply(show, "**𖢿╎جـارِ البحـث عـن الحسابـات المحذوفـة ⌯**")
        async for user in show.client.iter_participants(show.chat_id):
            if user.deleted:
                del_u += 1
                await sleep(0.5)
        if del_u > 0:
            del_status = f"**𖢿╎تم ايجـاد  {del_u}  من  الحسابـات المحذوفـه في هـذه المجموعـه**\n**𖢿╎لحذفهـم إستخـدم الأمـر  ⩥ :**  `.المحذوفين تنظيف`"
    ...
    if not admin and not creator:
        await edit_delete(show, "**𖢿╎ليس لـدي صلاحيـات المشـرف هنـا ؟!**", 5)
        return
    event = await edit_or_reply(show, "**𖢿╎جـارِ حـذف الحسـابات المحذوفـة ⌯**")
    del_u = 0
    del_a = 0
    async for user in show.client.iter_participants(show.chat_id):
        if user.deleted:
            try:
                ...
                await edit_delete(event, "**𖢿╎ ليس لدي صلاحيات الحظر هنا**", 5)
                return
            except UserAdminInvalidError:
                del_a += 1
    if del_u > 0:
        del_status = f"**𖢿╎تـم حـذف  {del_u}  الحسـابات المحذوفـة ✓**"
    if del_a > 0:
        del_status = f"**𖢿╎تـم حـذف {del_u} الحسـابات المحذوفـة، ولڪـن لـم يتـم حذف الحسـابات المحذوفـة للمشرفيـن !**"
    ...
    if BOTLOG:
        await show.client.send_message(
            ...
            f"**𖢿╎تنظيف :**\
            \n𖢿╎{del_status}\
            \n*𖢿╎المحادثـة ⌂** {show.chat.title}(`{show.chat_id}`)",
        )
...
async def count(event):
    ...
    result += f"𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼**- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
    result += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    result += f"**𖢿╎المستخدمون :**\t**{u}**\n"
    result += f"**𖢿╎المجموعات :**\t**{g}**\n"
    result += f"**𖢿╎المجموعات الخارقه :**\t**{c}**\n"
    result += f"**𖢿╎القنوات :**\t**{bc}**\n"
    result += f"**𖢿╎البوتات :**\t**{b}**\n"
    result += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
...
async def zed(event):
    ...
    try:
        ...
        return await edit_delete(zedevent, "**𖢿╎عـذراً عـزيـزي .. انت لسـت مشرفـاً هنـا 🙇🏻**", 5)
    await zedevent.edit(f"**𖢿╎رابـط الـمجموعـه ⎋:**\n\n⎌ [{chat.title}]({ZL.link}) ⎌")   
...
async def zed(event):
    ...
    if k:
        ...
        return await event.edit(
            f"**𖢿╎لديـه هنـا ⇽**  `{a.total}`  **رسـالـه 📩**"
        )
    zzm = event.pattern_match.group(1)
    if zzm:
        a = await bot.get_messages(event.chat_id, 0, from_user=zzm)
        return await event.edit(
            f"**𖢿╎المستخـدم** {zzm} **لديـه هنـا ⇽**  `{a.total}`  **رسـالـه 📩**"
        )
    else:
        zzm = "me"
    a = await bot.get_messages(event.chat_id, 0, from_user=zzm)
    await event.edit(
        f"**𖢿╎لديـك هنـا ⇽**  `{a.total}`  **رسـالـه 📩**"
    )   
...
async def _(event):
    ...
    try:
        ...
        await event.edit("**𖢿╎تم تفعيل وضع تقييد المحتوى .. بنجـاح ✓**")
...
async def _(event):
    ...
    await event.edit("**𖢿╎تم حذف الدردشة مع المستخدم .. بنجـاح ✓**")
