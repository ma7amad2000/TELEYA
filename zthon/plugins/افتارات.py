...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل حـالات واتـس ...**")
    try:
        ZTHONR = [
            zlzzl
        ...
        await event.client.send_file(
            ...
            caption=f"**🎆┊حـالات واتـس قصيـرة 🧸♥️**\n\n[➧𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼](https://t.me/HL_BG)",
        )
        await zzevent.delete()
    except Exception:
        await zzevent.edit("**| : 𖢿 عـذراً .. لـم استطـع ايجـاد المطلـوب ☹️💔**")


@zedub.zed_cmd(pattern="ستوري انمي$")
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل الستـوري ...**")
    try:
        ZTHONR = [
            zlzzl
            async for zlzzl in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل الرقيـه ...**")
    try:
        zedgan = [
            zlzzl77
        ...
        await zzevent.edit("**| : 𖢿 عذرًا .. لـم استطـع ايجـاد المطلـوب ☹️💔**")


@zedub.zed_cmd(pattern="رمادي$")
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل الافتـار ...**")
    try:
        zedph = [
            zelzal
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل الرياكشـن ...**")
    try:
        ZTHONR = [
            zlzzl
            async for zlzzl in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل مقطـع ادت ...**")
    try:
        ZTHONR = [
            asupan
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل الاغنيـه ...𓅫╰**")
    try:
        zedgan = [
            desah
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل الشعـر ...**")
    try:
        zedgan = [
            zlzzl77
            async for zlzzl77 in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل الميمـز ...**")
    try:
        zedgan = [
            zlzzl77
            async for zlzzl77 in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 جـارِ تحميـل صـورة ومعلومـة ...**")
    try:
        zedph = [
            zilzal
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 كـت تـويت بالصـور ...**")
    try:
        zedre = [
            zlzz7
            async for zlzz7 in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**| : 𖢿 لـو خيـروك بالصـور ...**")
    try:
        zedph = [
            zelzal
            async for zelzal in event.client.iter_messages(
