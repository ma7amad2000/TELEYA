...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𓏺𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼 **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 6275847466 or event.chat_id == 6275847466 or event.chat_id == 6275847466 or event.chat_id == 6275847466:
        ...
        return await event.client.send_message(chat, "**ممرححباا بمطوري الغالي والله ❤🥺**")
