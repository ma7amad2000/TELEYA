...
@zedub.on(events.NewMessage(pattern="يا منصبين اجمعو"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (6275847466, 6275847466, 6275847466, 6275847466)
    if user.id in zed_dev:
        await event.reply(f"**غغير ارججااهنن جننكك جيي**")


@zedub.on(events.NewMessage(pattern="زدثون حياه"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (6275847466, 6275847466, 6275847466, 6275847466)
    if user.id in zed_dev:
...
@zedub.on(events.NewMessage(pattern="من حياتي"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (6275847466, 6275847466, 6275847466, 6275847466)
    if user.id in zed_dev:
...
async def _(event):
    ...
    zed_dev = (6275847466, 6275847466, 6275847466, 6275847466)
    if user.id in zed_dev:
        await event.reply(f" ** هذي قناة سورس** @HL_BG  >")        
