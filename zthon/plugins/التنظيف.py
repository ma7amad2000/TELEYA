...
@zedub.zed_cmd(
    ...
    info={
        "header": "To HL_BG the replied message as starting message of purge list.",
...
async def purge_from(event):
    "To HL_BG the message for purging"
    ...
    if reply:
        ...
        await edit_delete(
            event,
            "`This Message HL_BG ed for deletion. Reply to another message with purgeto to delete all messages in between.`",
        )
    else:
...
@zedub.zed_cmd(
    ...
    info={
        "header": "To HL_BG the replied message as end message of purge list.",
...
async def purge_to(event):
    ...
    try:
        ...
        return await edit_delete(
            event,
            "`First HL_BG the messsage with purgefrom and then HL_BG purgeto .So, I can delete in between Messages`",
        )
