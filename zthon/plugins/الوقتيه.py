...
ZelzalVP_cmd = (
    "𓆩 [𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼 - اوامـر الفـارات](t.me/HL_BG) 𓆪\n\n"
    "**𖢿𝞝╎قائـمه اوامـر تغييـر زخـارف البروفايـل + الاسـم الوقـتي بأمـر واحـد فقـط - حقـوق لـ التـاريـخ 🦾 :** \n\n"
    "⪼ `.وقتيه 1` / `.الوقتي 1`\n\n"
    "⪼ `.وقتيه 2` / `.الوقتي 2`\n\n"
    "⪼ `.وقتيه 3` / `.الوقتي 3`\n\n"
    "⪼ `.وقتيه 4` / `.الوقتي 4`\n\n"
    ...
    "⪼ `.وقتيه 16`\n\n"
    "⪼ `.وقتيه 17`\n\n\n"
    "**𖢿𝞝╎لـ رؤيـة زغـارف البروفايـل الوقتـي ↶**  [⦇  اضـغـط هنــا  ⦈](t.me/ZCALIPHZ) \n\n"
    "**𖢿𝞝╎لـ رؤيـة زغـارف الاســم الوقتـي ↶**  [⦇  اضـغـط هنــا  ⦈](t.me/ZCALIPHZ) \n\n\n"
    "🛃 سيتـم اضـافة المزيـد من الزغـارف بالتحديثـات الجـايـه\n\n"
    "\n𓆩 [ٓ𓏺᭙ɦᎥ᥉ƙᥱᥡ🇱🇾|](t.me/BP_BP) 𓆪"
)
...
async def variable(event):
    ...
    zed = await edit_or_reply(event, "**𖢿𝞝╎جـاري اضـافة زخـرفـة الوقتيـه لـ بوتـك 💞🦾 . . .**")
    ...
    if input_str == "1":
        ...
        if gvarstatus("DEFAULT_PIC") is None:
            await zed.edit("**𖢿𝞝╎تم اضـافـة زغـرفـة البروفـايل الوقـتي {} بنجـاح ☑️**\n\n**𖢿𝞝╎الان قـم بـ ارسـال الامـر ↶** `.البروفايل` **لـ بـدء البروفـايل الوقتـي . .**".format(input_str))
        else:
            await zed.edit("**𖢿𝞝╎تم تغييـر زغـرفـة البروفـايل الوقـتي {} بنجـاح ☑️**\n\n**𖢿𝞝╎الان قـم بـ ارسـال الامـر ↶** `.البروفايل` **لـ بـدء البروفـايل الوقتـي . .**".format(input_str))
...
async def hhhzelzal(event):
    ...
    if input_str == "1":
        ...
        if gvarstatus("ZI_FN") is not None:
            await zed.edit("**𖢿𝞝╎تم تغييـر زغـرفة الاسـم الوقتـي .. بنجـاح✓**\n**𖢿𝞝╎نـوع الزخـرفـه {} **\n**𖢿𝞝╎الان ارسـل ↶** `.الاسم تلقائي`".format(zinfo))
        else:
            await zed.edit("**𖢿𝞝╎تم إضـافة زغـرفة الاسـم الوقتـي .. بنجـاح✓**\n**𖢿𝞝╎نـوع الزخـرفـه {} **\n**𖢿𝞝╎ارسـل الان ↶** `.الاسم تلقائي`".format(zinfo))
...
async def variable(event):
    input_str = event.pattern_match.group(1)
    zed = await edit_or_reply(event, "**𖢿𝞝╎جـاري اضـافة زخـرفـة خـط الحقـوق لـ بوتـك 💞🦾 . . .**")
    # All Rights Reserved for "@Zed-Thon" "زلـزال الهيبـه"
    if input_str == "1":
        variable = "ZED_FONTS"
        zinfo = "zthon/helpers/styles/ZThon.ttf"
        ...
        if gvarstatus("ZED_FONTS") is None:
            await zed.edit("**𖢿𝞝╎تم اضـافـة زغـرفـة خـط الحقـوق {} بنجـاح ☑️**\n\n**𖢿𝞝╎الان قـم بـ ارسـال الامـر ↶** `.حقوق` **+ كلمـه بالـرد ع (صوره-ملصق-متحركه-فيديو) . .**".format(input_str))
        else:
            await zed.edit("**𖢿𝞝╎تم تغييـر زغـرفـة خـط الحقـوق {} بنجـاح ☑️**\n\n**𖢿𝞝╎الان قـم بـ ارسـال الامـر ↶** `.حقوق` **+ كلمـه بالـرد ع (صوره-ملصق-متحركه-فيديو) . .**".format(input_str))
        addgvar(variable, zinfo)
    elif input_str == "2":
        variable = "ZED_FONTS"
        zinfo = "zthon/helpers/styles/Starjedi.ttf"
