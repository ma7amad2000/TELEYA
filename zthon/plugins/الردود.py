...
ZelzalWF_cmd = (
    "𓆩 [𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الـردود / والتـرحيب](t.me/ZZZ7iZ) 𓆪\n\n"
...
async def add_new_filter(event):
    ...
    if msg and msg.media and not string:
        if BOTLOG:
            ...
            await edit_or_reply(
                event,
                "**𖢿𝞝╎يتطلب رد ميديـا تعيين كـروب السجـل اولاً ..**\n**𖢿𝞝╎لاضافـة كـروب السجـل**\n**𖢿𝞝╎اتبـع الشـرح ⇚** https://https://t.me/HL_BG/146",
            )
            return
...
async def on_snip_list(event):
    ...
    filters = get_filters(event.chat_id)
    for filt in filters:
        if OUT_STR == "** 𖢿𝞝╎لاتوجـد ردود في هـذه الدردشـه ༗**":
            OUT_STR = "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**  ⪼ قائمـه الـردود في هذه الدردشـه :  **\n"
        OUT_STR += "⪼ {}  𓆰.\n".format(filt.keyword)
    await edit_or_reply(
        event,
        OUT_STR,
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝗭𝗧𝗵𝗼𝗻𝙃𝘼𝙔𝘼𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:
        await edit_or_reply(event, "**𖢿𝞝╎عـذراً .. لا توجـد ردود في هـذه المجموعـه**")
