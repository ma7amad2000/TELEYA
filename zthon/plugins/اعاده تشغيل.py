...
async def _(event):
    ...
    sandy = await edit_or_reply(
        ...
        f"**•⎆┊يتـم الان اعـادة تشغيـل بـوت حيـاه قـد يستغـرق الامـر 1-2 دقيقـه ▬▭ ...**",
    )
    try:
...
async def _(event):
    ...
    await edit_or_reply(event, "**✾╎هِٰيٰ ثٖوَِꪆآِإَنَٖيٰ وَِꪆحٰٖآِنَٖڜٰڜٰتغٓلَٖ😻 ٖ 📟 ...**\n\n**✾╎شغِّـلنـي يـدويًـا لاحقًــا**\n**✾╎باتبـاع الشـرح** https://t.me/HL_BG")
...
async def _(event):
    ...
    sleep(counter)
    await event.edit("**✾╎ٖجيتتتڪم🏃...**\n**✾╎انا ٖ في وضـع التشغيـل ☑️**")
