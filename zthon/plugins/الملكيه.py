...
async def _(event):
    ...
    if gvarstatus("TG_2STEP_VERIFICATION_CODE") is None:
        return await edit_or_reply(event, "**𖢿╎قم اولاً بـ اضـافة كـود التحقق بخطوتين الخـاص بك لـ الفـارات **\n**𖢿╎عبـر الامـر : ↶**\n `.اضف التحقق` **بالـرد ع كـود التحقق الخـاص بك**\n\n**𖢿╎ثم ارسـل الامـر : ↶**\n`.تحويل ملكية` **ومعـرف الشخص**\n\n**𖢿╎لتحويـل ملكيـة القنـاة/الكـروب للشخـص**")
    try:
        ...
        await event.edit("**𖢿╎تم نقـل الملكيـه .. بنجـاح✓**")
