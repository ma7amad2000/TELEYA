...
#                                                             𝙕𝙏𝙝𝙤𝙣
# =========================================================== #
SONG_SEARCH_STRING = "<b>╮ آِإَسُتِٰنَٖآِإَ آِإَنَٖدوَٖꪆࢪٖلڪِٰ فَِآِإَلمَِٰطلوَٖبٰٖ يآِإَڂِٰيي...🎧♥️╰</b>"
SONG_NOT_FOUND = "<b>✧╎آِإَسُفَِ مَِٰآِإَلقٰٖيتِٰڜ لي تِٰبٰٖيُه 🥺💔 .. جرب البحث باستخـدام الامـر (.اغنيه)</b>"
...
async def song(event):
    ...
    zedevent = await edit_or_reply(event, "**╮ آِإَسُتِٰنَٖآِإَ آِإَنَٖدوَٖꪆࢪٖلڪِٰ فَِآِإَلمَِٰطلوَٖبٰٖ يآِإَڂِٰيي...🎧♥️╰**")
    video_link = await yt_search(str(query))
    if not url(video_link):
        return await zedevent.edit(
            f"**✧╎ .. آِإَسُفَِ مَِٰآِإَلقٰٖيتِٰڜ لي تِٰبٰٖيُه 🥺💔** {query}"
        )
